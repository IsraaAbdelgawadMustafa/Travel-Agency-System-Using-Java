...
public class RoomBooking extends javax.swing.JFrame {
    ...
    public RoomBooking(int BID, int price) {
        initComponents();
        this.bookingID = BID;
        this.price = price;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          try 
       {
           ...
           Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="insert into room_booking values('" + bookingID + "', " + CustID + ")"; 
            st.executeUpdate(sql);
            
            setVisible(false);
            ChoosePaymentMethod ob2= new ChoosePaymentMethod(price, bookingID);
            ob2.setVisible(true);
        } 
       catch (Exception e) 
       {
