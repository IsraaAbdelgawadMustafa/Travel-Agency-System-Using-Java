...
public class AddBookingGUI extends javax.swing.JFrame {
   ...
   private final String userName = "root";
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Airline booking");
        ...
        jCheckBox2.setText("Hotel booking");
        ...
        jCheckBox4.setText("Tour booking");
   ...
   {
      AirlineFORM airform = new AirlineFORM();
      airform.setVisible(true);
   }
   ...
   {
       carrRentalGUI add = new carrRentalGUI();
       add.setVisible(true);
   }
   if(jCheckBox4.isSelected())
   {
       displayTours add = new displayTours();
       add.setVisible(true);
   }
      ...
      if(jCheckBox2.isSelected())
   {
      ...
      if(jCheckBox4.isSelected())
   {
        displayTours a= new displayTours();
      a.setVisible(true);
   }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBookingGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddBookingGUI().setVisible(true);
            }
        });
    }
